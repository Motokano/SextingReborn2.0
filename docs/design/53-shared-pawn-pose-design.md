...
> 后续补全：[54号完整组合设计](54-pawn-combined-injury-poses.md)和[状态数据v2](../../assets/map/isometric/concepts/shared-pose-map-v2.json)显式覆盖128种组合，包括P3/P4/P5的头胸腹伤态；后续复用v2，v1保留作历史。
